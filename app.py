...
# =====================================================
# ROBUST .ENV LOADING (FIXED)
# =====================================================

BASE_DIR = Path(__file__).resolve().parent
ENV_PATH = BASE_DIR / ".env"

# Load exact .env beside app.py
...
# st.write("Key Loaded:", os.getenv("GROQ_API_KEY"))
...
if not groq_key:
    st.error("❌ Add GROQ_API_KEY in .env or enter in sidebar.")
    st.stop()
...
if uploaded_file:
    ...
    question = st.text_input(
        "Type your question:",
        placeholder="Example: What are payment terms?"
    )
